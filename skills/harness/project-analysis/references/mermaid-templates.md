...
Mermaid、ASCII/TUI、表格和纯文本都是可选表达方式。只选择能让当前关系更清晰的形式；仅当终端审阅确实需要第二种表示时，才同时提供语义一致的 ASCII/TUI 预览。
...
当 ASCII/TUI 比 Mermaid 更适合终端审阅，或用户明确要求双格式时，可使用这些模板。若同时提供两种表示，保持节点、方向和关键分支语义一致。
