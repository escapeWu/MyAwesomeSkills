...
| [perplexity-search](./skills/perplexity-search) | Perplexity HTTP endpoint search with config-driven quick/balanced/expert/deep routing, source extraction, and optional JSON output. |
